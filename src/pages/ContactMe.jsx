  ...
  return (
    <section id="contact" className="py-16 bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-2xl sm:text-5xl lg:text-4xl font-bold text-green-300 mb-8">
          Get in Touch
        </h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full p-3 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-300"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3 px-6 bg-green-400 text-black rounded-full font-semibold hover:bg-green-500 transition-all duration-300"
            >
